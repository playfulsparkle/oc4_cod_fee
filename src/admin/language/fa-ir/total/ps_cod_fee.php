<?php
// Heading
$_['heading_title']              = 'Playful Sparkle - کارمزد پرداخت در محل';
$_['heading_contact']            = 'تماس با پشتیبانی';

// Text
$_['text_extension']             = 'افزونه‌ها';
$_['text_success']               = 'عملیات با موفقیت انجام شد: شما «کارمزد پرداخت در محل» را ویرایش کردید!';
$_['text_edit']                  = 'ویرایش کارمزد پرداخت در محل';
...
$_['entry_sort_order']           = 'ترتیب چیدمان';

// Error
$_['error_total_ps_cod_fee_fee'] = 'مقدار کارمزد نمی‌تواند خالی، کمتر یا مساوی صفر باشد';

// Error
$_['error_permission']           = 'هشدار: شما مجوز لازم برای ویرایش «کارمزد پرداخت در محل» را ندارید!';
