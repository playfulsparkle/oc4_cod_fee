...
class PSCodFee extends \Opencart\System\Engine\Controller
{
     ...
     */
    const EXTENSION_DOC = 'https://github.com/playfulsparkle/oc4_cod_fee.git';
    ...
    public function save(): void
    {
        ...
        if (!$json && isset($this->request->post['total_ps_cod_fee_fee']) && (float) $this->request->post['total_ps_cod_fee_fee'] <= 0) {
